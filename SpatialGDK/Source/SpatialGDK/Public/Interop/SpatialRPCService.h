...
private:
	TOptional<uint32_t> FindFreeSlotForCrossServerSender(Worker_EntityId Sender);
	...
	TMap<Worker_EntityId, CrossServer::SenderState> ActorSenderState;
	...
	TMap<Worker_EntityId_Key, TArray<CrossServer::ACKSlot>> CrossServerACKMap;
